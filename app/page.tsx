...
export default function Home(){
 return <main className="site-shell">
  ...
  <header className="site-header">
   ...
   <nav className="site-nav" aria-label="เมนูหลัก"><a href="#games">เกม</a><a href="#about">เกี่ยวกับ</a></nav>
  </header>
  ...
  <section className="hero" id="top">
   ...
   <div className="hero-actions"><a className="button primary" href="#games">เลือกเกม <Icon name="arrowRight"/></a><a className="button secondary" href="#about">MindPlay ทำงานอย่างไร</a></div>
  ...
  <section className="privacy-panel">
   ...
   <div><p className="eyebrow">เล่นได้อย่างสบายใจ</p><h2>ความลึกลับอยู่ในตัวเกม ไม่ใช่การแอบดูอุปกรณ์</h2><p>MindPlay ไม่เปิดกล้อง ไม่เปิดไมค์ และไม่ต้องใช้บัญชีผู้ใช้ เกมใช้เพียงสิ่งที่คุณเลือกตอบหรือทำตามบนหน้าจอเพื่อสร้างประสบการณ์มายากลและทายใจ</p></div>
  </section>

  <section className="section" id="about">
   <div className="section-heading"><div><p className="eyebrow">ออกแบบเพื่อการเล่นจริง</p><h2>เข้าใจง่ายบนมือถือ แท็บเล็ต และคอมพิวเตอร์</h2></div><p>แต่ละหน้ามีสิ่งที่ต้องทำเพียงอย่างเดียว ลดข้อมูลแน่น ลดเอฟเฟกต์รบกวน และเน้นจังหวะสำคัญตอนอ่านใจและเฉลย</p></div>
   <div className="feature-grid">
    ...
    <article><span><Icon name="speed"/></span><h3>เบาและตอบสนองไว</h3><p>Motion เน้น transform และ opacity พร้อม Reduced Motion</p></article>
   </div>
  </section>
